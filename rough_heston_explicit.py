...
def main():
    ...
    num_steps = [4, 8, 16, 32, 64, 128, 256, 512, 1024] # Number of time steps
    x_mesh_size = [4, 8, 16, 32, 64, 128, 256, 512, 1024] # mesh-size in the spatial domain in each coordinate
    #L_low = -0.5
    #L_up = 3.5
    L_low = np.array([-3, 0])
    L_up = np.array([1, 4])
